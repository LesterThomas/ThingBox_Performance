...
{
    createGauge("mem", "Memory");
    createGauge("cpu", "CPU");
    createGauge("network", "Network",0,200000);
}
...
function updateGauges()
{
    $.getJSON( "/api/performance", function( data ) {
      ...
      var mem=(data.mem.used*100)/data.mem.total;
      gauges["cpu"].redraw(cpu);
      gauges["mem"].redraw(mem);
    ...
    function loadEditor() {
        RED.menu.init({id:"btn-sidemenu",
            options: [
                ...
                null,
                {id:"btn-console",icon:"fa fa-list",label:"Console",href:"/console.txt"},
                null,
                {id:"btn-console-settings",icon:"fa fa-cog",label:"Settings",href:"/api/form/settings"},
                null,
                {id:"btn-restart",label:"Restart Node-RED", onselect:function() {
					$.ajax({
						type: "POST",
						url: "/inject/restart"
						});
					}},
                {id:"btn-reboot",label:"Reboot the Thingbox", onselect:function() {
					$.ajax({
						type: "POST",
						url: "/inject/reboot"
						});
	    	...
	    	null,
                ...
                {id:"btn-help",label:"Documentation", href:"http://thethingbox.io/docs/index.html"},
